                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="site-nav-bar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="{{route('opremaUser')}}"><b><i><u>Oprema</u></i></b></a></li>
                    ...
                    <div class="boxed">
                        ...
                        <div class="col-sm-6">
                                ...
                                <div class="shop-box-hover text-center">
                                    <div class="c-table">
                                        <div class="c-cell">
                                            ...
                                            <form action="{{route('dodajUserOpremuUKosaru')}}" method="POST">
                                                @csrf
                            ...
                            <div class="shop-box-title">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h4>{{$item->Naziv_proizvoda}}
                                            
                                        </h4><br>
                                        @if($item->proizvod_id==14)
                                        <br>
                                        <br>
                                        <br>
                                        @endif
                                        @if($item->proizvod_id==20)
                                        <br>
                                        @endif
                                    </div>
                                    <div class="col-sm-6">
