...
//URL::forceRootUrl('http://studenti.sum.ba/projekti/fsre_rwa/2020/g10');
Route::get('/', function () {
    return view('index');
});
...
Route::get('/Onama.html',[ProizvodiController::class,'oNama'])->name('oNama');
Route::get('/index.html',[ProizvodiController::class,'indexIndex'])->name('indexIndex');  
...
Route::get('signup.html', [SignUpController::class,'index'])->name('singUpIndex');
Route::get('login.html', [LoginController::class,'index'])->name('loginIndex');
...
Route::get('userOnama.html',[LoginController::class,'userOnama'])->name('userOnama');
