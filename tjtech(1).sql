...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2021 at 02:10 PM
...
CREATE TABLE `opremas` (
  `oprema_id` int(10) UNSIGNED NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `Povecana_slika` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `opremas` (`oprema_id`, `Opis`, `Cijena`, `Slika`, `created_at`, `updated_at`, `Povecana_slika`) VALUES
(1, 'Monitor Asus 27\" TUF GAMING VG27VH1B, VA, Gaming, Adaptive-sync, FreeSync Premium 165Hz, VGA, HDMI, Zvučnici, Zakrivljeni 1500R, Full HD ', '$ 354,59', 'assets/images/shop-111.jpg', NULL, NULL, 'assets/images/shop-big-111.jpg'),
(2, 'Monitor Philips 24\" 241B8QJEB, IPS, VGA, DVI, HDMI, DP, 2xUSB3.0, 2xUSB2.0, Pivot, Zvučnici, Full HD', '$ 216,21', 'assets/images/shop-222.jpg', NULL, NULL, 'assets/images/shop-big-222.jpg'),
(3, 'Miš Genius Scorpion Spear, RGB LED, crni', '$ 12,61', 'assets/images/shop-333.jpg', NULL, NULL, 'assets/images/shop-big-333.jpg'),
(4, 'Podloga za miš MS TERIS M105, gaming', '$ 1,56', 'assets/images/shop-444.jpg', NULL, NULL, 'assets/images/shop-big-444.jpg'),
(5, 'Tipkovnica MS FLARE gaming LED', '$ 216,21', 'assets/images/shop-555.jpg', NULL, NULL, 'assets/images/shop-big-555.jpg'),
(6, 'Slušalice Sony WH-CH510, bežične, NFC/Bluetooth, crne', '$ 48,88', 'assets/images/shop-666.jpg', NULL, NULL, 'assets/images/shop-big-666.jpg'),
(7, 'Slušalice Logitech H650e, stereo, s mikrofonom, USB', '$ 93,08', 'assets/images/shop-777.jpg', NULL, NULL, 'assets/images/shop-big-777.jpg'),
(8, 'Miš MS IMPERATOR 2, gaming, žični', '$ 9,81', 'assets/images/shop-888.jpg', NULL, NULL, 'assets/images/shop-big-888.jpg'),
(9, 'Tipkovnica Speedlink Niala, UK/HR Layout, crna', '$ 7,94', 'assets/images/shop-999.jpg', NULL, NULL, 'assets/images/shop-big-999.jpg'),
(10, 'Gaming stolica LC-Power LC-GC-600BR, crno/crvena', '$ 182,12', 'assets/images/shop-100.jpg', NULL, NULL, 'assets/images/shop-big-100.jpg');
...
CREATE TABLE `racunalos` (
  ...
  `Memorija` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Graficka` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Cijena` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Slika` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(6, 'Gamer Anubis Pro', 'Intel Core i9 10900K up to 5.3GHz', '32GB DDR4', '1TB NVMe SSD', 'NVIDIA RTX3090 24GB', '$ 4898,90', 'assets/images/shop-66.jpg', 'assets/images/shop-big-66.jpg', 1, NULL, NULL),
...
--
ALTER TABLE `kategorijas`
  MODIFY `kategorija_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `korisniks`
--
ALTER TABLE `korisniks`
  MODIFY `korisnik_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `opremas`
  MODIFY `oprema_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `racunalos`
--
ALTER TABLE `racunalos`
  MODIFY `proizvod_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
